...
public class SellCurrentExpiryBuyNextExpiryIntradayAXISBANK {
	...
	public static void main(String[] args) throws IOException, KiteException, WebSocketException {
		...
		try {
			...
			tokenAndName.put("SPOT", new OptionDetails(Long.parseLong("1510401"), "AXISBANK")); 
			tokenAndName.put("BUY", new OptionDetails(Long.parseLong("16495106"), "AXISBANK21APRFUT"));
			tokenAndName.put("SELL", new OptionDetails(Long.parseLong("15676930"), "AXISBANK21MAYFUT"));
