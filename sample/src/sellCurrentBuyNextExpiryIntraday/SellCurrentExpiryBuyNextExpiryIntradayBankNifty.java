...
public class SellCurrentExpiryBuyNextExpiryIntradayBANKNIFTY {
	...
	public static void main(String[] args) throws IOException, KiteException, WebSocketException {
		...
		try {
			...
			tokenAndName.put("BUY", new OptionDetails(Long.parseLong("16491522"), "BANKNIFTY21APRFUT")); 
			tokenAndName.put("SELL", new OptionDetails(Long.parseLong("15665922"), "BANKNIFTY21MAYFUT")); 
