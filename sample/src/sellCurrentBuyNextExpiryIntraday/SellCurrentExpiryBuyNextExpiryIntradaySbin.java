...
public class SellCurrentExpiryBuyNextExpiryIntradaySBIN {
	...
	public static void main(String[] args) throws IOException, KiteException, WebSocketException {
		...
		try {
			...
			tokenAndName.put("SPOT", new OptionDetails(Long.parseLong("779521"), "SBIN")); 
			tokenAndName.put("BUY", new OptionDetails(Long.parseLong("16593666"), "SBIN21APRFUT"));
			tokenAndName.put("SELL", new OptionDetails(Long.parseLong("15787266"), "SBIN21MAYFUT"));
