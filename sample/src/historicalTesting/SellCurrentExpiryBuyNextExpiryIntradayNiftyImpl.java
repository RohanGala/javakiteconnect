...
public class SellCurrentExpiryBuyNextExpiryIntradayNiftyImpl {
	...
	public void executeBuySell11(final KiteConnect kiteConnect, final ArrayList<Long> tokens,
			final Map<String, OptionDetails> tokenAndName,final Examples examples,final String CEbuyTradingSymbol,final String CESellTradingSymbol, final String fileName, String SpotPrice) throws IOException, WebSocketException, KiteException {
