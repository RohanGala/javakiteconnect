 ...
 * 
 */
public class SellFutureSellPEBuyCE {
	...
	public static void main(String[] args) throws IOException, KiteException, WebSocketException {
		...
		SellFutureSellPEBuyCEImpl rsi = new SellFutureSellPEBuyCEImpl();
		try {

			Map<String, OptionDetails> tokenAndName = new HashMap<>();
			tokenAndName.put("SELLFUT", new OptionDetails(Long.parseLong("16492034"), "NIFTY21APRFUT"));
			tokenAndName.put("SELLOPTION", new OptionDetails(Long.parseLong("11226626"), "NIFTY2140815000PE")); 
			tokenAndName.put("BUYOPTION", new OptionDetails(Long.parseLong("11226370"), "NIFTY2140815000CE")); 

			ArrayList<Long> tokens = new ArrayList<>();
			tokens.add(tokenAndName.get("SELLFUT").getInstrumentToken());
			...
			// first execute 1:2
			 ...
			 tokens,tokenAndName,examples,tokenAndName.get("SELLFUT").getTradingSymbol(),tokenAndName.get("BUYOPTION").getTradingSymbol(),tokenAndName.get("SELLOPTION").getTradingSymbol());
