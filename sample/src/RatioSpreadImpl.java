...
public class RatioSpreadImpl {

	
	public void executeRatioSpreads11(final KiteConnect kiteConnect, final ArrayList<Long> tokens,
        ...
        tickerProvider.setOnTickerArrivalListener(new OnTicks() {
            ...
            public void onTicks(ArrayList<Tick> ticks) {
                ...
                if(ticks.size() > 0) {
                	...
                	if (entryPrice <= -5.85 && !orderPlaced && !squareOffDone) {
                		try {
                	...
                	else if(!squareOffDone && orderPlaced && FinalPrice > 4) {
